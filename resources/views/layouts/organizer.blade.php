...
<nav class="flex-1 space-y-2">
    ...
    <!-- MENU QR SCANNER TANPA IKON -->
    <a href="{{ route('organizer.scanner') }}" 
       class="flex items-center gap-3 px-4 py-3 {{ request()->routeIs('organizer.scanner') ? 'bg-indigo-800 text-white' : 'text-indigo-200 hover:text-white' }} hover:bg-indigo-800 rounded-xl font-bold transition">
        QR Scanner
    </a>
</nav>
        </nav>

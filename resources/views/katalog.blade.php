...
<body class="bg-slate-100 flex items-center justify-center h-screen">
    <div class="bg-white p-8 rounded-xl shadow-lg border border-slate-200 text-center max-w-sm w-full">
        ...
        <p class="text-slate-500 mb-6">Jelajahi berbagai event menarik dari AMIKOM Event Hub</p>
        ...
        <div class="grid grid-cols-2 gap-3">
            ...
            <a href="/profil" class="inline-block bg-emerald-600 text-white font-semibold py-2 px-4 rounded-lg hover:bg-emerald-700 hover:shadow-md transition duration-300">
                Profil
            </a>

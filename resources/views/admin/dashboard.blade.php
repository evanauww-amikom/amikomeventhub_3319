                    ...
                    @forelse($latestTransactions as $trx)
                        <tr class="hover:bg-slate-50 transition">
                            ...
                            <td class="px-8 py-6">
                                ...
                                @endphp
                                <span class="px-3 py-1 {{ $statusColor }} rounded-lg text-xs font-bold uppercase">{{ $trx->status }}</span>
                            </td>
                            <td class="px-8 py-6 font-black text-indigo-600">Rp {{ number_format($trx->total_price, 0, ',', '.') }}</td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="4" class="px-8 py-10 text-center text-slate-400 font-medium">Belum ada transaksi.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
